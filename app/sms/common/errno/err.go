...
const (
	...
	SendTooManyMsg            = "send too many"
	VerifyTooManyMsg          = "verify too many"
)
...
var (
	...
	SendTooMany   = NewErrno(SendTooManyCode, SendTooManyMsg)
	VerifyTooMany = NewErrno(VerifyTooManyCode, VerifyTooManyMsg)
)
