...
var file_idl_user_proto_depIdxs = []int32{
	...
	6, // 4: user.UserService.GetUserExists:input_type -> user.GetUserExistsRequest
	1, // 5: user.UserService.GetUserInfo:output_type -> user.GetUserInfoResponse
	3, // 6: user.UserService.Register:output_type -> user.RegisterResponse
	5, // 7: user.UserService.Login:output_type -> user.LoginResponse
	7, // 8: user.UserService.GetUserExists:output_type -> user.GetUserExistsResponse
